...
<?php include("com/header.php"); ?>
    ...
    <section class="people peopleBack">
        <div class="container even">
            <div class="row">
                <div class="col s12 m6">
                    <p><img src="i/people.jpg" alt="Some description" class="responsive-img"></p>                
                </div>
                <div class="col s12 m6">                
    ...
    <section class="systems systemsBack">
        <div class="container odd">
            <div class="row">
                <div class="col s12 m6">                
    ...
    <section class="innovation innovationBack">
        <div class="container even">
            <div class="row">
                <div class="col s12 m6">
                    <p><img src="i/innovation.jpg" alt="Some description" class="responsive-img"></p>                
                </div>
                <div class="col s12 m6">                
    ...
    <section class="products productsBack">
        <div class="container odd">
            <div class="row">
                <div class="col s12 m6">                
    ...
    <section class="money moneyBack">
        <div class="container even">
            <div class="row">
                <div class="col s12 m6">
                    <p><img src="i/money.jpg" alt="Some description" class="responsive-img"></p>                
                </div>
                <div class="col s12 m6">                
    ...
    <section class="growth growthBack">
        <div class="container odd">
            <div class="row">
                <div class="col s12 m6">                
