...
<?php include("com/header.php"); ?>
    ...
    <div class="container">
        ...
        <h3>TLDR: Dreams drive realisation of our intended future.</h3>
        ...
        <h3>TLDR: Future authoring is the first step to creating our intended future.</h3>
        ...
        <h3>TLDR: There are many areas in which we can make a difference.</h3>
